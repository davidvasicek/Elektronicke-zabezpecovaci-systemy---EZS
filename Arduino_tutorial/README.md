...
Kód projektu Arduina naleznete zde: [Arduino.ino]() 

v kódu je nutné upravit následující parametry:

- **server_IPaddr**: Adresa serveru Raspberry Pi
- **ssid**: SSID sítě přes kterou bude Arduino komunikovat
- **password**: heslo pro dané SSID
