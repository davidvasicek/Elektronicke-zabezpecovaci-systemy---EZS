...
1. **Stažení operačního systému** Software Arduino IDE je dostupný na oficiálních stráchkách společnosti Arduino [Download zde](https://www.arduino.cc/en/main/software). Instalační soubor je možné stáhnout v sekci  *Download the Arduino IDE* kliknutím na *Windows Installer* a následným kliknutím na tlačítko *JUST DOWNLOAD*

2. **Instalace softwaru** Stažený instalační soubor Arduina IDE otevřeme, software nainstalujeme a následně spustíme
